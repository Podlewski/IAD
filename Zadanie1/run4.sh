...
rm -rf Wyniki/Wyniki4_C2.txt
for (( i=1; $i <= 20; i++ ))
do
  for (( k=1; $k <= 5; k++ ))
  do
    ./Program.py Data/approximation_train_1.txt 1 1 -q Data/approximation_test.txt --lino -n $i -i 3 -b -sre Wyniki/Wyniki4_C1.txt
    ./Program.py Data/approximation_train_2.txt 1 1 -q Data/approximation_test.txt --lino -n $i -i 3 -b -sre Wyniki/Wyniki4_C2.txt
  done
done
