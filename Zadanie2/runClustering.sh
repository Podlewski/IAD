...
for i in {0..19}
do
  ./Program.py -ac -sc 0 0 5 222 -n 20 -t -d ResultsC/2B
  ./Program.py -ac -sw -5 0 3 111 -sr 2 3 7 -3 111 -n 20 -t -d ResultsC/2B
done
...
for i in {0..19}
do
  ./Program.py -ac -r 5 5 -sc 0 0 5 222 -n 20 -t -d ResultsC/2B
  ./Program.py -ac -r 5 5 -sw -5 0 3 111 -sr 2 3 7 -3 111 -n 20 -t -d ResultsC/2B
done
...
for i in {0..19}
do
  ./Program.py -ac -rl -sc 0 0 5 222 -n 20 -t -d ResultsC/2B
  ./Program.py -ac -rl -sw -5 0 3 111 -sr 2 3 7 -3 111 -n 20 -t -d ResultsC/2B
done
...
for i in {0..19}
do
  ./Program.py -ac -rs -sc 0 0 5 222 -n 20 -t -d ResultsC/2B
  ./Program.py -ac -rs -sw -5 0 3 111 -sr 2 3 7 -3 111 -n 20 -t -d ResultsC/2B
done
