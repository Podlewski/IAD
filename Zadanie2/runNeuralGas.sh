...
for i in {0..19}
do
 ./Program.py -ag -lp 0.05 0.1 -sc 0 0 5 222 -n 20 -d ResultsG/1B
 ./Program.py -ag -lp 0.01 0.1 -sw -5 0 3 111 -sr 2 3 7 -3 111 -n 20 -d ResultsG/1B
done
...
for i in {0..19}
do
 ./Program.py -ag -rl -olp -sc 0 0 5 222 -n 20 -d ResultsG/1B
 ./Program.py -ag -rl -olp -sw -5 0 3 111 -sr 2 3 7 -3 111 -n 20 -d ResultsG/1B
done
...
for i in {0..19}
do
 ./Program.py -ag -rs -olp -sc 0 0 5 222 -n 20 -d ResultsG/1B
 ./Program.py -ag -rs -olp -sw -5 0 3 111 -sr 2 3 7 -3 111 -n 20 -d ResultsG/1B
done
